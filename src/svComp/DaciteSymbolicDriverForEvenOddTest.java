...
*/
public class DaciteSymbolicDriverForEvenOddTest {
    public static int dacite_symbolic_driver_isOdd() {
        /* Input values */
        int arg0 = Mulib.rememberedFreeInt("arg0");
        int r0 = EvenOdd.isOdd(arg0);
        return r0;
    }
    public static int dacite_symbolic_driver_isEven() {
        /* Input values */
        int arg0 = Mulib.rememberedFreeInt("arg0");
        int r0 = EvenOdd.isEven(arg0);
        return r0;
    }
}
