...
*/
public class DaciteSymbolicDriverForFibonacciTest {
    public static int dacite_symbolic_driver_fibonacci() {
        /* Input values */
        int arg0 = Mulib.rememberedFreeInt("arg0");
        int r0 = Fibonacci.fibonacci(arg0);
        return r0;
    }
}
