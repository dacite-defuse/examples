...
*/
public class DaciteSymbolicDriverForSortTest {
    public static int[] dacite_symbolic_driver_sort() {
        /* Input values */
        int[] arg0 = Mulib.rememberedFreeObject("arg0", int[].class);
        // To restrict the array size use: Mulib.assume(array.length<...);
        Mulib.assume(arg0.length<4);
        int[] r0 = Sort.sort(arg0);
