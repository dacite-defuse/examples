...
*/
public class DaciteSymbolicDriverForEuclidianTest {
    public static int dacite_symbolic_driver_egcd() {
        /* Input values */
        int arg1 = Mulib.rememberedFreeInt("arg1");
        int arg2 = Mulib.rememberedFreeInt("arg2");
        EuclidianGcd arg0 = Mulib.rememberedFreeObject("arg0", EuclidianGcd.class);
        int r0 = arg0.egcd(arg1,arg2);
