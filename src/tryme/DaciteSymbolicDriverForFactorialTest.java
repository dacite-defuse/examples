...
*/
public class DaciteSymbolicDriverForFactorialTest {
    public static int dacite_symbolic_driver_factorial() {
        /* Input values */
        int arg0 = Mulib.rememberedFreeInt("arg0");
        int r0 = Factorial.factorial(arg0);
        return r0;
    }
}
